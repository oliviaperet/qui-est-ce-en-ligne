...
export function CharacterThumb({
  ...
  return (
    <Tag
      ...
      onClick={onClick}
      className={`group relative flex flex-col overflow-hidden rounded-2xl border-[3px] bg-white text-left transition ${
    ...
    >
      <div className="relative aspect-square w-full overflow-hidden bg-blue-tint">
